package com.meetyou.library.widget.pulltorefresh;
...
import com.meetyou.library.R;
import com.meetyou.library.widget.pulltorefresh.indicator.PtrIndicator;
...
public class MeetYouPtrFrameLayout extends PtrFrameLayout implements PtrUIHandler {
    ...
    public MeetYouPtrFrameLayout(Context context) {
        super(context);
        initView();
    }

    public MeetYouPtrFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public MeetYouPtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView() {
        ...
        View view = View.inflate(this.getContext(), R.layout.meetyou_head_view, null);
