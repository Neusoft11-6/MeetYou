 ...
 */
package com.meetyou.cn.mvp.base;
...
public class BasePresenter<M extends IModel, V extends IView> implements IPresenter, LifecycleObserver {
    ...
    public BasePresenter(M model, V rootView) {
        Preconditions.checkNotNull(model, String.format("%s cannot be null",IModel.class.getName()));
        Preconditions.checkNotNull(rootView,String.format("%s cannot be null",IView.class.getName()));
        this.mModel = model;
